...
export AIRFLOW__LOGGING__BASE_LOG_FOLDER=/rds/general/user/igf/ephemeral/airflow_logs/logs
export AIRFLOW__LOGGING__DAG_PROCESSOR_MANAGER_LOG_LOCATION=/rds/general/user/igf/ephemeral/airflow_logs/logs/dag_processor_manager/dag_processor_manager.log
...
export AIRFLOW__CORE__SQL_ALCHEMY_POOL_ENABLED=True
export AIRFLOW__CORE__SQL_ALCHEMY_POOL_SIZE=50
export AIRFLOW__CORE__SQL_ALCHEMY_MAX_OVERFLOW=50
export AIRFLOW__CORE__SQL_ALCHEMY_POOL_RECYCLE=3600
export AIRFLOW__CORE__DEFAULT_TIMEZONE='Europe/London'
export AIRFLOW__CORE__PARALLELISM=100
export AIRFLOW__CORE__DAG_CONCURRENCY=20
export AIRFLOW__CORE__DAGS_ARE_PAUSED_AT_CREATION=False
export AIRFLOW__CORE__NON_POOLED_TASK_SLOT_COUNT=10
export AIRFLOW__CORE__MAX_ACTIVE_RUNS_PER_DAG=100
export AIRFLOW__CORE__MAX_ACTIVE_TASKS_PER_DAG=100
