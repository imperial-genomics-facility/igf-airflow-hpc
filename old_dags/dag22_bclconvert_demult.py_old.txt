			...
			demult_pj_start = \
				BranchPythonOperator(
					...
					params={
						...
						"max_lanes": MAX_LANES,
						"lane_task_prefix": "project_{0}.dummy_demultiplexing_of_project_{0}_lane_".\
											format(project_id)},
								...
								sample_groups_ig = \
									BranchPythonOperator(
										...
										params={
											...
											'lane_index': lane_id,
											'ig_index': ig_id,
											'next_task_prefix': "project_{0}.lane_{1}.ig_{2}.qc_ig_{2}.md5_known_ig_{0}_lane_{1}_project_{2}_sample_".\
								...
								for sample_id in range(1, MAX_SAMPLES+1):
										...
										PythonOperator(
											...
											params={
												...
												'xcom_task_for_bclconvert_output': "project_{0}.lane_{1}.ig_{2}.bclconvert_project_{0}_lane_{1}_ig_{2}".\
																					format(project_id, lane_id, ig_id),
												'xcom_key_for_sample_group': 'sample_group',
												'xcom_task_for_sample_group': "project_{0}.lane_{1}.ig_{2}.qc_ig_{2}.sample_groups_project_{0}_lane_{1}_ig_{2}".\
																			format(project_id, lane_id, ig_id),
									...
									load_fastq_and_qc_to_db = \
										PythonOperator(
											...
											params={
												"xcom_key_for_checksum_sample_group": "checksum_sample_group",
												"xcom_task_for_checksum_sample_group": "project_{0}.lane_{1}.ig_{2}.qc_ig_{2}.md5_known_ig_{0}_lane_{1}_project_{2}_sample_{3}".\
																						format(ig_id, lane_id, project_id, sample_id),
										...
										PythonOperator(
											...
											params={
												...
												'xcom_task_for_bclconvert_output': "project_{0}.lane_{1}.ig_{2}.bclconvert_project_{0}_lane_{1}_ig_{2}".\
																				   format(project_id, lane_id, ig_id),
												"xcom_key_for_collection_group": "collection_group",
												"xcom_task_for_collection_group": "project_{0}.lane_{1}.ig_{2}.qc_ig_{2}.load_fastq_and_qc_ig_{0}_lane_{1}_project_{2}_sample_{3}".\
																				  format(ig_id, lane_id, project_id, sample_id),
											},
